...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5feafdc1888018001574548c
...
To start editing your site, you can use the Sanity interface at https://charming-apple-afdc1.sanity.studio/.
...
Generated at `2020-12-29T09:58:47.709Z` by Stackbit version `0.3.42`.